import { PLAYER_WIDTH, PlayerModelsScales, PlayerModelsUrlsArray, SECTOR_CONTENT_ELEVATION } from "@/lib/constants";
...
function ColorBox({ position, color, isSelected, isColorless, onClick }: Omit<ModelProps, 'url'>) {
	const [isHovered, setHover] = useState(false);
