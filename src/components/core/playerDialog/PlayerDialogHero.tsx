...
function PlayerDialogHero({ name, avatar, socials }: Props) {
  return (
    <div className="relative mb-8 pt-[76px]">
      ...
      <div className="font-black text-4xl text-center mb-2">{name}</div>
      <div className="flex gap-5 justify-center">
        {socials.map((url) => (
          <Button className="text-muted-foreground hover:text-foreground h-auto p-0" key={url} variant="link">
